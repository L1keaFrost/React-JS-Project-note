                ...
                <div className="text">
                    <form action="" onSubmit={loadDataFromForm} className={formClass}>
                        <div className="form-group">
                            ...
                            <textarea name="note" className="form-control" defaultValue="Введите текст" id="note"></textarea>
                    ...
                    <div className={lineClass}>
                        ...
                        <div className="text-right"><button onClick={function () { window.location.reload() }} className="btn btn-primary">Создать еще одну заметку</button></div>
                    </div>
                </div>
            </div>
        </div>
