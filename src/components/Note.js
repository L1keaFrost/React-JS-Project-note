        ...
        <div className="row">
            <div className="col-12">
                <div className="text">
                    <form action="" onSubmit={getNote} className={formClass}>
                        <div className="form-group">
                            <label htmlFor="url">Введите номер заметки</label>
                ...
                <div className={lineClass}>
                    ...
                    <div className="text-right"><button onClick={searchNote} className="btn btn-primary">Искать другую Заметку</button></div>
                </div>
